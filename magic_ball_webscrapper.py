...
class Controller(MagicBall):
    ...
    def exec_scrapping(self, controller):
        google_scrapper = GoogleScrapper()
        google_scrapper.search(controller)

        random_site_scrapper = RandomSiteScrapper(google_scrapper.get_data)
        random_site_scrapper.search(controller)

        return random_site_scrapper.get_data
...
class GoogleScrapper(Webscrapper):
...
class RandomSiteScrapper(Webscrapper):
